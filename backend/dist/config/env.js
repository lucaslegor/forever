...
exports.authCookieMaxAgeSeconds = exports.env = void 0;
...
function getJwtSecret() {
    ...
    if (isProduction) {
        if (!secret || secret === 'default-secret-change-me' || secret.length < 32) {
            throw new Error('En producción JWT_SECRET es obligatorio en .env y debe tener al menos 32 caracteres aleatorios. ' +
...
function jwtExpiresInToSeconds(expiresIn) {
...
exports.authCookieMaxAgeSeconds = jwtExpiresInToSeconds(exports.env.JWT_EXPIRES_IN);

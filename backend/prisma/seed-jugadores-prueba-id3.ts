...
const JUGADORES: JugadorSeed[] = [
  { nombre: 'Juan', apellido: 'Perez', dni: '40111222', genero: 'Masculino', categoria: 'Mayores' },
  { nombre: 'Lucas', apellido: 'Gomez', dni: '40111333', genero: 'Masculino', categoria: 'Mayores' },
  { nombre: 'Mateo', apellido: 'Fernandez', dni: '42111444', genero: 'Masculino', categoria: 'Juveniles' },
  { nombre: 'Nicolas', apellido: 'Lopez', dni: '43111555', genero: 'Masculino', categoria: 'Infantiles' },
  { nombre: 'Tomas', apellido: 'Ruiz', dni: '44111666', genero: 'Masculino', categoria: 'Infantiles' },
  { nombre: 'Sofia', apellido: 'Martinez', dni: '40111777', genero: 'Femenino', categoria: 'Mayores' },
  { nombre: 'Valentina', apellido: 'Diaz', dni: '40111888', genero: 'Femenino', categoria: 'Mayores' },
  { nombre: 'Camila', apellido: 'Torres', dni: '42111999', genero: 'Femenino', categoria: 'Juveniles' },
  { nombre: 'Martina', apellido: 'Sosa', dni: '43111001', genero: 'Femenino', categoria: 'Infantiles' },
  { nombre: 'Julieta', apellido: 'Vega', dni: '44111002', genero: 'Femenino', categoria: 'Infantiles' },
];
